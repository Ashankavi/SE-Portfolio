...
const Contact = () => {
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:legioncodeitsolutions@outlook.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
      `Name: ${name}\nPhone: ${phone}\n\nMessage:\n${message}`
  ...
  return (
    <div className='relative flex flex-col h-auto p-4 mt-8 bg-black bg-center bg-cover ' style={{ backgroundImage: `url(${Background})` }}>
      <div className='flex flex-row items-center justify-between flex-grow p-4 pt-10'>
        <div className='relative flex flex-grow flex-wrap w-full md:w-[800px]'>
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl md:text-6xl text-[#ffffff] font-bold uppercase">Let's get in <br />touch today!</h2>
          </div>
        </div>
      </div>
      ...
      <div className='flex flex-col px-4 sm:flex-col md:flex-row '>
        <div className='flex flex-col flex-grow p-4 text-white'>
          <h2 className="text-2xl md:text-l font-bold mb-4 text-[#ffffff]">Lorem ipsum dolor sit amet consectetur adipiscing <br />elit amet diam in est pharetra  porttitor libero netus nulla.</h2>
          <div className='flex flex-row my-4'>
            <img className='w-6 h-6 ' src={Telephone} alt="Telephone" />
            <p className='ml-2 text-xl font-bold md:text-xl'>+94 775 655 031 <br /> +94 775 655 031</p>
          </div>
          <div className='flex flex-row mb-4 '>
            <img className='w-6 h-6 ' src={Email} alt="Email" />
            <p className='ml-4 text-xl font-bold md:text-l'>hello@gmail.com</p>
          </div>
          <div className='flex flex-row mb-4 '>
            <img className='w-6 h-8' src={Location} alt="Location" />
            <p className='ml-4 text-xl font-bold md:text-l'>No 500<br /> Colombo Road,<br /> Dehiwala</p>
          </div>
